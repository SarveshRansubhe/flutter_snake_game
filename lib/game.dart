...
class _GamePageState extends State<GamePage> {
  ...
  Offset getRandomFoodPositionWithinRange() {
    int posX = Random().nextInt(upperBoundX-15) + lowerBoundX;
    int posY = Random().nextInt(upperBoundY-15) + lowerBoundY;
    return Offset(roundToNearestTens(posX).toDouble(),
        roundToNearestTens(posY).toDouble());
  }
  ...
  void drawFood() {
    ...
    if (foodPosition == null) {
      foodPosition = getRandomFoodPositionWithinRange();
    }
